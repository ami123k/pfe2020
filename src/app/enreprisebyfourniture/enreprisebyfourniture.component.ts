...
@Component({
  selector: 'app-enreprisebyfourniture',
  templateUrl: './enreprisebyfourniture.component.html',
  styleUrls: ['./enreprisebyfourniture.component.css']
})
export class EnreprisebyfournitureComponent implements OnInit {
  public offres: Offre;
  ...
  ngOnInit(): void {
    this.uploadService.getlistentreprisebyefourniture(this.categorie).subscribe(e => {
      this.t1 = e;
      console.log(this.t1);
    });
    this.afficheroffre();
