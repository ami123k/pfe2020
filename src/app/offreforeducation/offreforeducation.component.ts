...
@Component({
  selector: 'app-offreforeducation',
  templateUrl: './offreforeducation.component.html',
  styleUrls: ['./offreforeducation.component.css']
})
export class OffreforeducationComponent implements OnInit {
