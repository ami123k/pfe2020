...
@Component({
  selector: 'app-entreprisebyeducation',
  templateUrl: './entreprisebyeducation.component.html',
  styleUrls: ['./entreprisebyeducation.component.css']
})
export class EntreprisebyeducationComponent implements OnInit {
  public offres: Offre;
  ...
  ngOnInit(): void {
    this.uploadService.getlistentreprisebyeducation(this.categorie).subscribe(e => {
      this.t1 = e;
      console.log(this.t1);
    });
    this.afficheroffre();
