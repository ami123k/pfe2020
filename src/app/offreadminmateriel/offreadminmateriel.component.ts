...
@Component({
  selector: 'app-offreadminmateriel',
  templateUrl: './offreadminmateriel.component.html',
  styleUrls: ['./offreadminmateriel.component.css']
})
export class OffreadminmaterielComponent implements OnInit {
  constructor(private catservice: ServiceOffreService, private activatedRoute: ActivatedRoute,
  ...
  afficheroffre() {
    ...
    console.log(this.categorie);
    this.uploadService.getlistoffrebymate(this.categorie).subscribe(data => {this.offres = data; },
      error1 => {console.log(error1); });
