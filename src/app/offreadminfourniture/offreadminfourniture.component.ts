...
@Component({
  selector: 'app-offreadminfourniture',
  templateUrl: './offreadminfourniture.component.html',
  styleUrls: ['./offreadminfourniture.component.css']
})
export class OffreadminfournitureComponent implements OnInit {
  ...
  afficheroffre() {
    ...
    console.log(this.categorie);
    this.uploadService.getlistoffrebyfourniture(this.categorie).subscribe(data => {this.offres = data; },
