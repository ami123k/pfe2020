...
@Component({
  selector: 'app-offreformateriel',
  templateUrl: './offreformateriel.component.html',
  styleUrls: ['./offreformateriel.component.css']
})
export class OffreformaterielComponent implements OnInit {
